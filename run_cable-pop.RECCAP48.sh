...
if [[ "${system}" == "cuntz@explor" ]] ; then
	...
	#ParamPath="/g/data/x45/BIOS3_forcing/acttest9/params/"           # only in bios.nml
	#GlobalLandMaskFile="/g/data/x45/BIOS3_forcing/reccap1000pts/reccap1000pts" # no file extension
	...
	GlobalLandMaskFile="/g/data/x45/BIOS3_forcing/aust_0.25_pts/australia_op_maskv2ctr25" # no file extension
        GlobalMetPath="/g/data/x45/BIOS3_forcing/aust_0.25_pts/met/"          # last slash is needed - updated 29/3/2024
	ParamPath="/g/data/x45/BIOS3_forcing/aust_0.25_pts/params/"
        GlobalTransitionFilePath="/g/data/x45/LUH2/v3h/${degrees}deg_aust/EXTRACT"
    fi
    # Global LUC
    # GlobalTransitionFilePath="/g/data/x45/LUH2/GCB_2019/1deg/EXTRACT"
